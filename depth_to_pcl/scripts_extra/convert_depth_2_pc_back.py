...
def main():
    ...
    camera_info_sub = rospy.Subscriber('/camera1/depth/camera_info', CameraInfo, info_callback)
    
    pc_pub = rospy.Publisher('/realsense_back', PointCloud2, queue_size=1)
    ...
    while not rospy.is_shutdown():
        if camera_info_received and depth_image is not None:
            ...
            depth_image_resized = cv2.resize(depth_image, (depth_image.shape[1] // 4, depth_image.shape[0] // 4), interpolation=cv2.INTER_NEAREST)
